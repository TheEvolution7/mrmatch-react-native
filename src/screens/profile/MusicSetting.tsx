...
export default function MusicSetting({ closeModal }) {
    const navigation = useNavigation();
    const interests = [
        'Pop', 'Rock', 'R&B', 'Country', 'Jazz', 'Hip-Hop', 'Classical', 'Electronic',
        'Indie', 'Reggae', 'Blues', 'Metal', 'Latin', 'K-Pop', 'Punk', 'Alternative',
        'Folk', 'Funk', 'World', 'EDM', 'Rap', 'Soul', 'Opera', 'Disco', 'Ambient',
        'Ska', 'J-Pop', 'Bollywood', 'Gospel', 'House', 'New Age', 'Trance', 'Techno',
        'Salsa', 'Flamenco', 'Swing', 'Acoustic', 'Synth-Pop', 'Choir', 'Grunge', 'Chiptune',
        'Barbershop', 'Chamber', 'Downtempo', 'Psychedelic', 'Progressive', 'Experimental',
        'Industrial', 'World Fusion', 'Trip-Hop'
    ];
    const [selectedInterests, setSelectedInterests] = React.useState(userStore.musicRef);
    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: 20, width: '100%' }}>
            ...
            <TouchableOpacity onPress={() => {
                userStore.setMusic(selectedInterests);
                closeModal(false);
