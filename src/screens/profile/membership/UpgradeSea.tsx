...
const ProfileAction: React.FC<ProfileActionProps> = ({ title }) => {
    return (
        <View style={styles.wrapModule}>
            <Image source={require('../../../assets/images/checkGuide_blue2.png')} style={styles.icon} />
        ...
        <View style={styles.container}>
            <LinearGradient locations={[0, 0.5, 1]} colors={['rgba(0, 177, 216, 0)', 'rgba(0, 177, 216, 0)', 'rgba(0, 177, 216, 0.3)']} useAngle={true} angle={130.24} style={styles.backgr}>
                <View style={styles.wrapHeader}>
                    <Image source={require('../../../assets/images/heartMr_blue2.png')} style={styles.heart} />
                    <View style={styles.basicBtn}>
                        <Text style={styles.riverTxt}>Sea</Text>
                    </View>
                </View>
                ...
                <View style={styles.wrapBtn}>
                    <TouchableOpacity style={styles.btnFree}>
                        <Text style={[styles.txt, { color: '#a1eeff' }]}>Free Trial</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {
                        navigation.navigate('PaymentMethod');
                        userStore.settypeSub(TYPESUBS.SEA);
...
const styles = StyleSheet.create({
    container: {
        shadowColor: "rgba(0, 177, 216, 0.5)",
        shadowOffset: {
            width: 0,
            height: 0
        },
        ...
        borderStyle: "solid",
        borderColor: "rgba(0, 177, 216, 0.5)",
        borderWidth: 1,
        width: "100%",
        marginTop: 32,
    },
