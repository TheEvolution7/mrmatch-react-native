...
export const ModeButton: React.FC = () => {
    ...
    // const [IsIconOnStyle, setIsIconOn] = useState(false);
        ...
        <View>
                <View className="flex flex-row justify-between items-center space-x-2 px-[20px]">
                    ...
                    >
                        <LinearGradient
                            locations={[0, 1]}
                            colors={isOn ? ['#bb9a65', '#775d34'] : ['#3A4A5A', '#3A4A5A']}
                            useAngle={true}
                            angle={101.24}
                            className="py-[12px] px-[24px] rounded-[800px]">
                            <Text className="text-white text-[16px] font-medium">
                                {isOn ? 'Enabled' : 'Disable'}
                            </Text>
                        </LinearGradient>
                    </TouchableOpacity>
                ...
                <View className="w-full" pointerEvents={isOn ? 'auto' : 'none'}>
                    <View className="flex justify-center space-x-2 px-[20px]">
                        <Text
                            className={`${isOn ? 'text-[#BB9A65]' : 'text-[#2D3843]'
                                } font-heading font-medium text-[20px] leading-[24px] mt-[30px] mb-[30px]`}>
                            {isOn ? 'Fearures' : 'Features (Disabled)'}
                        </Text>
                    </View>
                    <View
                        className={`${isOn ? 'opacity-[1]' : 'opacity-[0.5]'
